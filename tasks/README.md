...
|----|------|--------|------|-----------|--------|
| [T01](T01-scaffolding.md) | Scaffolding, Inngest wiring & env contract | `ready` | 0 | — | T02, T07 |
| [T02](T02-foundation-libs.md) | Foundation libs: Mongo/GridFS, data model, adapters, settings | `blocked` | 1 | T01 | T03, T04, T05, T06, T14, T17 |
| [T03](T03-agent-tools.md) | AgentKit tools (search/fetch/poster/save) | `blocked` | 2 | T02 | T04, T15, T17 |
...
| [T07](T07-design-system.md) | Design system — implement in code per DESIGN_PROMPT.md | `blocked` | 1 | T01 | T08, T09 |
