...
| R-0008 | T04 | blocker | No OPENROUTER_API_KEY/SERPER_API_KEY/MONGODB_URI to live-run buildNetwork(options).run(topic) end-to-end; router determinism fully verified in isolation (9/9 vitest cases, zero external services) | T05,T18 | true | open |
