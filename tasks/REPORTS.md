...
| R-0006 | T09 | info | T09 stopped its dev server with a broad `Get-Process -Name node \| Stop-Process -Force` (Windows), which is not scoped to its own process and could kill sibling worktrees' (T03/T08) dev servers on this shared machine | T03,T08 | false | open |
